...
public:
    ...
    void GetSmoothMesh(CVX_Object* pObj); // creates smooth (marching cubes) mesh for standards editor (added by atsmsmr)
    void SetSmoothMesh(CVX_Object* pObj, CMesh* pMeshIn);
